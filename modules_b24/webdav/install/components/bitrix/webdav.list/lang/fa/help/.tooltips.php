...
$MESS["DOCS_COUNT_TIP"] = "Specifies the number of elements per page.";
$MESS["SORT_BY1_TIP"] = "Select here the field by which the documents items are to be sorted. You can select <b><i>(other)</i></b> and specify the field ID in the field beside.";
$MESS["SORT_ORDER1_TIP"] = "Ascending or descending.";
$MESS["SORT_BY2_TIP"] = "Select here the field by which the documents items are to be sorted in the second pass. You can select <b><i>(other)</i></b> and specify the field ID in the field beside.";
...
$MESS["DETAIL_URL_TIP"] = "The URL of a detail view page. For example: <b>doc_detail.php?ID=#ELEMENT_ID#</b>";
