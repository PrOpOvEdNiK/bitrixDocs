...
$MESS["CACHE_TYPE_TIP"] = "<i>Auto</i>: el caché es válido durante el tiempo predefinido en la configuración del caché;<br /><i>Cache</i>: siempre utilizar el caché para el período especificado en el siguiente campo;<br /><i>No almacenar en caché</i>: no se realiza el almacenamiento en caché.";
