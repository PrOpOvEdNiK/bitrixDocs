...
$MESS["DETAIL_URL_TIP"] = "Il est indiqué le modèle du lien vers la page avec l'affichage détaillé. Par exemple, <b>doc_detail.php?ID=#ELEMENT_ID#</b>";
...
$MESS["DOCS_COUNT_TIP"] = "Ce chiffre détermine le nombre d'éléments affichés sur la page.";
$MESS["FIELD_CODE_TIP"] = "Dans ce champ on peut choisir les champs des éléments du bloc d'information pour lesquels le filtrage sera possible. On peut y ajouter d'autres champs sous forme de code symbole (dans les champs situés plus bas).";
...
$MESS["SORT_BY1_TIP"] = "La liste indique tous les champs où peut être réalisé le tri de documents. Vous pouvez également sélectionner <b><i>(autre)</i></b> et indiquer le code du champ désiré dans le champ à côté.";
$MESS["SORT_BY2_TIP"] = "La liste contient les champs qui permettent de réaliser le deuxième tri de documents, si les valeurs de champs du premier tri sont les mêmes. Vous pouvez également sélectionner le point <b><i>(autre)</i></b> et introduire dans le champ à côté le code du champ désiré.";
