...
$MESS["LANDING_OPT_PUB_PATH_HEADER"] = "Ruta al sitio publicado, relacionado con la raíz del sitio";
$MESS["LANDING_OPT_PUB_PATH_HELP"] = "Tenga en cuenta que no debe existir un archivo especificado con este nombre de ruta. El sistema lo creará al publicarlo y configurará las reglas de procesamiento.";
$MESS["LANDING_OPT_RIGHTS_EXTENDED_MODE"] = "Permisos extendidos";
$MESS["LANDING_OPT_SITE_TEMPLATE_ID"] = "ID de plantilla de aterrizaje";
$MESS["LANDING_OPT_SITE_TEMPLATE_ID_SITES"] = "Plantillas de sitio individuales";
