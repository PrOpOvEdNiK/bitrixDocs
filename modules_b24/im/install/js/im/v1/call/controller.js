;(function()
{
	...
	BX.Call.Controller = function(config)
	{
		...
		Object.defineProperty(this, "defaultMicrophone", {
			get: function() {
				return localStorage ? localStorage.getItem('bx-im-settings-default-microphone') : '';
			}
		});
		Object.defineProperty(this, "defaultCamera", {
			get: function() {
				return localStorage ? localStorage.getItem('bx-im-settings-default-camera') : '';
			}
		});
		Object.defineProperty(this, "defaultSpeaker", {
			get: function() {
				return localStorage ? localStorage.getItem('bx-im-settings-default-speaker') : '';
			}
		});
	...
	BX.Call.Controller.prototype = {
		...
		startCall: function(chatId, video)
		{
			...
			if(provider == BX.Call.Provider.Voximplant)
			{
				...
				if(this.preferHdQuality)
				{
					cameraParams.videoQuality = VoxImplant.Hardware.VideoQuality.VIDEO_SIZE_HD;
				}
			...
			}).then(function(e)
			{
				...
				this.currentCall.useHdVideo(this.preferHdQuality);
		...
		_onCallLocalMediaReceived: function(e)
		{
			...
			if(this.currentCall.videoEnabled && e.stream.getVideoTracks().length === 0)
			{
