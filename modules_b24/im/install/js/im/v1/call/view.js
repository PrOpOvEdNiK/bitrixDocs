;(function()
{
	...
	BX.Call.View.prototype.setDeviceList = function(deviceList)
	{
		...
		{
			if(this.cameraList.length > 0 && this.isMediaSelectionAllowed())
			{
		...
		{
			if(this.microphoneList.length > 0 && this.isMediaSelectionAllowed())
			{
			...
			switch (buttons[i])
			{
				...
				case "microphone":
					this.buttons.microphone = new ButtonWithArrow({
						...
						arrowEnabled: this.microphoneList.length > 0 && this.isMediaSelectionAllowed(),
				...
				case "camera":
					this.buttons.camera = new ButtonWithArrow({
						...
						arrowEnabled: this.cameraList.length > 0 && this.isMediaSelectionAllowed(),
