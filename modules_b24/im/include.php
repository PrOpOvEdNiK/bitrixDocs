...
$jsCoreRel = array('im_common', 'im_phone_call_view', 'clipboard', 'sidepanel', 'loader', 'ui.notification', 'ui.alerts');
...
/* TODO 2 tabs desktop
if (strpos(strtolower($userAgent), "bitrixdesktop") !== false)
{
...
CJSCore::RegisterExt('im_common', array(
	...
	'rel' => array('ls', 'ajax', 'date', 'fx', 'user', 'rest.client', 'phone_number', 'loader', 'ui.viewer', 'main.md5', 'im.debug')
));
