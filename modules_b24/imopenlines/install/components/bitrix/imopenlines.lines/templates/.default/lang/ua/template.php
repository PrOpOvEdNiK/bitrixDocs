...
$MESS["OL_COMPONENT_LIST_POPUP_LIMITED_TEXT_NEW"] = "На вашому тарифному плані є обмеження по кількості Відкритих ліній. Щоб додати ще одну лінію (наприклад, для створення декількох рівнів підтримки клієнтів), перейдіть на інший тарифний план.
<br><br>
