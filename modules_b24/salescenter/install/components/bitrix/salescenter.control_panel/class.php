...
class SalesCenterControlPanelComponent extends CBitrixComponent implements Controllerable
{
	...
	public function executeComponent(): void
	{
		...
		$this->arResult['panels'] = [
			...
			[
				'id' => static::PANEL_ID_SERVICES,
				'title' => Loc::getMessage('SALESCENTER_CONTROL_PANEL_SERVICES_PANEL_TITLE'),
				'items' => [
					$this->getServicesInChatTile(),
					$this->getServicesInSmsTile(),
				],
				'itemType' => 'BX.Salescenter.ServiceItem',
			],
			[
				'id' => static::PANEL_ID_PAYMENT_SYSTEMS,
				'title' => Loc::getMessage('SALESCENTER_CONTROL_PANEL_PAYMENT_SYSTEMS_PANEL_TITLE'),
	...
	protected function getCashboxesTile(): array
	{
		...
		return [
			'id' => 'cashboxes',
			'title' => Loc::getMessage('SALESCENTER_CONTROL_PANEL_CASHBOXES_TILE'),
