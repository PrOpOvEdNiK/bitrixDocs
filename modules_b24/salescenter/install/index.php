...
class salescenter extends CModule
{
	...
	function InstallDB($params = [])
	{
		...
		\Bitrix\Main\EventManager::getInstance()->registerEventHandler('sale', 'OnSaleOrderEntitySaved', 'salescenter', '\Bitrix\SalesCenter\Integration\SaleManager', 'OnSaleOrderEntitySaved');
	...
	function DoUninstall()
	{
		...
		\Bitrix\Main\EventManager::getInstance()->unRegisterEventHandler('sale', 'OnSaleOrderEntitySaved', 'salescenter', '\Bitrix\SalesCenter\Integration\SaleManager', 'OnSaleOrderEntitySaved');
