...
$MESS["CLUWIZ_INIT"] = "Inicialización";
$MESS["CLUWIZ_NO_CONN_ERROR"] = "Error al conectar la base de datos sumisa. El asistente finalizará ahora.";
$MESS["CLUWIZ_NO_MODULE_ERROR"] = "El módulo del web cluster no está instalado. El asistente finalizará ahora.";
$MESS["CLUWIZ_NO_NODE_ERROR"] = "La base de datos sumisa no está especificada. El asistente finalizará ahora.";
$MESS["CLUWIZ_STEP2_DELETE_TABLES"] = "Permitir tablas en la base de datos  #database# para ser eliminados";
$MESS["CLUWIZ_STEP2_NO_TABLES"] = "No se encontraron tablas; la transferencia de la base de datos está segura para su inicio.";
...
$MESS["CLUWIZ_STEP2_TITLE"] = "Comprobación para las tablas en la base de datos sumisa";
$MESS["CLUWIZ_STEP2_WARNING"] = "La sección pública del sitio web no está disponible durante la transferencia de la data.";
