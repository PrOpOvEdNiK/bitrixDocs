...
$MESS["CLU_MEMCACHE_LIST_ADD_TITLE"] = "Agregar a la Conexión de la Mem de caché";
$MESS["CLU_MEMCACHE_LIST_DELETE"] = "Eliminar";
$MESS["CLU_MEMCACHE_LIST_DELETE_CONF"] = "Eliminar conexión?";
...
<p>Memcached es muy recomendable para reducir el estrés de sincronización de archivos y la carga del servidor, ya que almacena los archivos en la memoria caché en lugar de en archivos físicos.</p>";
...
$MESS["CLU_MEMCACHE_LIST_TITLE"] = "Conexiones de la Mem del Caché";
$MESS["CLU_MEMCACHE_LIST_WARNING_NO_CACHE"] = "Atención! Caché está desactivado. Para habilitar,  utilizar una memoria de caché en conexión o modificar parámetros en .settings.php.";
