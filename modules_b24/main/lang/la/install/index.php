...
$MESS["main_install_sms_event_confirm_name"] = "Verifique su número de teléfono mediante SMS";
$MESS["main_install_sms_event_restore_descr"] = "#USER_PHONE# - número de teléfono
#CODE# - código de confirmación";
$MESS["main_install_sms_event_restore_name"] = "Recupere su contraseña mediante SMS";
$MESS["main_install_sms_template_confirm_mess"] = "Código de confirmación: #CODE#";
$MESS["main_install_sms_template_restore_mess"] = "Código para recuperar su contraseña: #CODE#";
?>