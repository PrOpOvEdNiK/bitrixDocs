...
$MESS["CL_MANUAL_TEST"] = "<p>La lista de verificación de control de calidad de implementación contiene recomendaciones proporcionadas por Bitrix Inc. a las que un desarrollador web tiene que adherirse al momento de realizar la integración y despliegue de cualquier proyecto web.</p> 
<p>Estas recomendaciones abarcan todas las etapas de desarrollo, desde el diseño de la plantilla de la solución web, las pruebas de estrés, la auditoría de seguridad, etc. y se basan en las mejores prácticas y técnicas desarrolladas por Bitrix Inc. para soluciones web de alta carga. Respete las recomendaciones de esta lista de control para así lograr un mejor rendimiento, alta seguridad y control de su proyecto web, y reducir los riesgos tecnológicos y costos de mantenimiento.</p> 
...
<li>El desarrollador deberá proporcionar su información personal y de la empresa en el item de lista de verificación correspondiente.</li>
