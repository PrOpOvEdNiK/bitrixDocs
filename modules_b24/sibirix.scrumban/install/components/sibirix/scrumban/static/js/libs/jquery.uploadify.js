...
var swfobject = function() {
    ...
    function testPlayerVersion() {
        ...
        ua.pv = SCRUMBAN.jQuery.flashVersion();
        matchVersions();
    }
...
SWFUpload.prototype.getFlashHTML = function () {
    return['<object style="position:absolute;z-index:1;" id="', this.movieName, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">', '<param name="wmode" value="', this.settings.button_window_mode, '" />', '<param name="movie" value="', this.settings.flash_url, '" />', '<param name="quality" value="high" />', '<param name="menu" value="false" />', '<param name="allowScriptAccess" value="always" />', '<param name="flashvars" value="' + this.getFlashVars() + '" />', "</object>"].join("")
};
    ...
    var methods = {
        ...
        init : function(options, swfUploadOptions) {
            ...
            return this.each(function() {
                ...
                var playerVersion  = $.flashVersion();
                var flashInstalled = (playerVersion[0] >= 9);
                ...
                if (flashInstalled) {
                    ...
                    swfuploadify.queueData = {
                        ...
                        errorMsg           : '' // Некоторые файлы не добавились в очередь
                    };
