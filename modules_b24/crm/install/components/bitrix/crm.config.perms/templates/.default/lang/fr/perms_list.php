...
$MESS["CRM_CONFIG_PERMS_REBUILD_DEAL_ATTRS"] = "Les droits d'accès mis à jour aux transactions exigent que vous <a id='#ID#' href='#URL#'>mettiez à jour</a> les attributs de droits d'accès pour les transactions précédemment créés.";
$MESS["CRM_CONFIG_PERMS_REBUILD_DEAL_ATTR_DLG_SUMMARY"] = "Attributs d'accès vont maintenant être reconstruits pour tous les devis. Cette procédure peut prendre un certain temps.";
$MESS["CRM_CONFIG_PERMS_REBUILD_DEAL_ATTR_DLG_TITLE"] = "Mettre à jour les attributs d'accès de devis";
