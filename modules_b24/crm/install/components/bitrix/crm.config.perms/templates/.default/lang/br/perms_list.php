...
$MESS["CRM_CONFIG_PERMS_REBUILD_COMPANY_ATTRS"] = "Por favor <a id=\"#ID#\" href=\"URL#\">atualização</a> para empresas já existentes antes de utilizar as permissões de acesso estendidas.";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_DEAL_ATTRS"] = "As permissões de acesso atualizadas de negócios exigem que você <a id=\"#ID#\" href=\"#URL#\">atualize</a>os atributos de acesso para negócios criados anteriormente.";
$MESS["CRM_CONFIG_PERMS_REBUILD_DEAL_ATTR_DLG_SUMMARY"] = "Os atributos de acesso não serão refeitos para todos os negócios Este procedimento pode demorar algum tempo.";
$MESS["CRM_CONFIG_PERMS_REBUILD_DEAL_ATTR_DLG_TITLE"] = "Atualizar os Atributos de Acesso de Negócios";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_LEAD_ATTRS"] = "As permissões de acesso atualizadas de Leads exigem que você <a id=\"#ID#\" href=\"#URL#\">atualize</a> os atributos de acesso para Leads criados anteriormente.";
$MESS["CRM_CONFIG_PERMS_REBUILD_LEAD_ATTR_DLG_SUMMARY"] = "Os atributos de acesso não serão refeitos para todos os Leads. Este procedimento pode demorar algum tempo.";
$MESS["CRM_CONFIG_PERMS_REBUILD_LEAD_ATTR_DLG_TITLE"] = "Atualizar os Atributos de Acesso de Leads";
