...
$MESS["CRM_CONFIG_PERMS_REBUILD_COMPANY_ATTRS"] = "Por favor <a id=\"#ID#\" href=\"#URL#\">actualice</a> los atributos de acceso para las compañías existentes antes de utilizar permisos de acceso extendidos.";
$MESS["CRM_CONFIG_PERMS_REBUILD_COMPANY_ATTR_DLG_SUMMARY"] = "Los atributos de acceso de la compañía se volverán a crear. Esta operación puede tardar algún tiempo.";
$MESS["CRM_CONFIG_PERMS_REBUILD_COMPANY_ATTR_DLG_TITLE"] = "Actualizar atributos de acceso de la compañía";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_DEAL_ATTRS"] = "Las actualizaciones de permisos de acceso de las negociaciones requieren que usted <a id=\"#ID#\" href=\"#URL#\">actualice</a> atributos de acceso creado previamente para las negociaciones.";
