<?
$MESS["CRM_LEAD_LIST_BATCH_CONVERSION_AUTOCREATION_DISABLED"] = "La conversión de grupo requiere que la opción \"Crear contactos automáticamente, compañías, negociaciones, facturas y cotizaciones\" se habilite en la página de configuración del CRM (Configuración> Otras configuraciones> General> Configuración de generación automática)";
$MESS["CRM_LEAD_LIST_BATCH_CONVERSION_CONFIG_IS_NOT_SUPPORTED"] = "Los prospectos no se pueden convertir con la configuración seleccionada.";
