...
if(typeof BX.Crm.EntityMerger === "undefined")
{
	...
	BX.Crm.EntityMerger.prototype =
	{
		...
		clearSecondaryEditorsLayout: function()
		{
			...
			this._editorButtons = null;
			this._editorMergerColumns = null;
			this._editorDetailButtons = null;
			this._editorWrappers = null;
		...
		{
			if(!this._editorDetailButtons)
			{
				this._editorDetailButtons = document.querySelectorAll('.crm-entity-widget-detail-btn');
			}

			return this._editorDetailButtons;
		},
		...
		onDetailButtonClick: function(item) {
			item.detailButton.addEventListener('click', this._headerButtonHandler);
			console.log('click: ', item.detailButton);
		},
...
if(typeof BX.Crm.EntityMergerHeader === "undefined")
{
	BX.Crm.EntityMergerHeader = function()
	{
		...
		this._headerButtonHandler = BX.delegate(this.onHeaderButtonClick, this);
