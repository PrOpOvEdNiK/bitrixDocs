...
(
	...
	INDEX IX_DEAL_11 (IS_RETURN_CUSTOMER, CATEGORY_ID, ID),
	INDEX IX_DEAL_12 (COMPANY_ID, IS_RETURN_CUSTOMER, ID),
	INDEX IX_DEAL_13 (CONTACT_ID, IS_RETURN_CUSTOMER, ID),
	INDEX IX_DEAL_14 (IS_REPEATED_APPROACH, CATEGORY_ID, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_order_deal
(
	DEAL_ID INT UNSIGNED NOT NULL,
	ORDER_ID INT UNSIGNED NOT NULL,
	PRIMARY KEY(DEAL_ID, ORDER_ID),
