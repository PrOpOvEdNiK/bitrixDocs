...
<p><b>O Customer relationship management (CRM)</b>é uma estratégia para gerenciar interações de uma empresa com consumidores, clientes e porspectos de vendas. Ela envolve o uso de tecnologia para organizar, automatizar e sincronizar processos de negócio - principamente atividades de venda, mas também para marketing e atendimento ao cliente. O CRM armazena informações de relacionamento com o cliente para análise adicional.</p>
 
<p>O CRM da Bitrix é contruído sob os seguintes conceitos.</p>
 
<ul> 
  <li><b>Contato</b> é um registro contendo dados de uma pessoa com o qual sua empresa já possui ou possuirá um relacionamento.</li>
