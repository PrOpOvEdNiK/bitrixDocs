...
$MESS["SECURITY_SITE_CHECKER_PHP_PRIVILEGED_USER_DETAIL"] = "Робота PHP від імені привілейованого користувача (наприклад, root) може позначитися на безпеці вашого проекту";
...
$MESS["SECURITY_SITE_CHECKER_BITRIX_TMP_DIR"] = "Тимчасові файли зберігаються в межах кореневої директорії проекту";
$MESS["SECURITY_SITE_CHECKER_BITRIX_TMP_DIR_DETAIL"] = "Зберігання тимчасових файлів, створюваних при використанні CTempFile, в межах кореневої директорії проекту не рекомендовано і несе з собою низку ризиків.";
...
1. Виберіть директорію поза кореня проекту. Наприклад, це може бути \"/home/bitrix/tmp/www\"<br>
