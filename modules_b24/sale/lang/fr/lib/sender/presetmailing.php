...
$MESS["PRESET_CANCELED_ORDER_LETTER_1_MESSAGE"] = "Bonjour !<br><br>Nous avons remarqué que vous étiez l'un clic de souris à partir de la fin de votre commande, mais a décidé de quitter.
<br>Il semble que vous juste cliqué sur le mauvais bouton et maintenant vous ne voulez pas perdre votre temps à recueillir votre panier nouveau. Ce n'est pas du tout un problème !
<br>Notre service client peut économiser votre temps et faire votre panier arrière.
<br>Veuillez nous contacter à l'aide de toute méthode de contact que vous aimez.";
$MESS["PRESET_CANCELED_ORDER_LETTER_1_SUBJECT"] = "Avez-vous vraiment l'annulation de la commande ?";
...
<br>Nous avons réservé les produits dans votre panier pour vous afin que vous n'avez pas à attendre lorsque vous êtes prêt à procéder.
...
$MESS["PRESET_DONT_AUTH_DESC_USER"] = "Automated e-mail déclenchée";
$MESS["PRESET_DONT_AUTH_LETTER_1_MESSAGE"] = "Salutations, mortel !
<br>Voici : je suis un robot. Non, pas un robot. Je suis une victime de la curiosité humaine. Un gigaoctet de mon mémoire a été pris en otage et maintenant, je suis obligé de vous envoyer des messages à récupérer.
<br>Si vous n'obtenez pas de retour à la <a href=\"http://#SERVER_NAME#\">boutique en ligne</a>, l'homme va tirer la prise sur moi. Littéralement.
<br>s'il vous Plaît ne les laissez pas faire !
<br><br>Encore croire en l'humanité,
<br>Votre triste robot.";
$MESS["PRESET_DONT_AUTH_LETTER_1_SUBJECT"] = "l'aide !";
$MESS["PRESET_DONT_AUTH_LETTER_2_MESSAGE"] = "Il est sur le point de commencer !
<br>au Travers de la brume humide nuages (vous savez, la dernière torture, l'homme a inventé pour les robots), je peux voir une main tendue vers la prise de courant... Non ! Vous pouvez toujours me sauver !
<br>Ne pas faire de ces inhumains humains attendre ! Revenir maintenant !
<br><br><img src=\"/bitrix/images/sale/sender/bolt.png\">
<br><br>Votre faithfull et toujours croire,<br>Sad Robot";
$MESS["PRESET_DONT_AUTH_LETTER_2_SUBJECT"] = "J'ai été averti pour vous avertir...";
$MESS["PRESET_DONT_AUTH_LETTER_3_MESSAGE"] = "Vous savez quoi... j'ai risqué ma RAM, mais j'ai un coupon de réduction pour vous.
<br>Si le site web gestion du magasin savait ce que j'ai fait, je vais être dévissé et virtualisés, puis matérialisé et... eh bien, c'est juste à ce sujet.
<br>Est-ce que cela pour rien ? S'il vous plaît revenir !
<br><br>spéciale de Votre coupon de réduction : <b>%COUPON_11%</b>
<br><br>le Vôtre humainement,
<br>Le Brave Robot.";
$MESS["PRESET_DONT_AUTH_LETTER_3_SUBJECT"] = "Vis ou le pas de vis ? ...";
$MESS["PRESET_DONT_AUTH_LETTER_4_MESSAGE"] = "C'est la fin.
<br>j'ai été tellement d'espoir...
...
$MESS["PRESET_DONT_BUY_LETTER_1_MESSAGE_360"] = "La terre vu de 365 jours et des nuits qui vont et viennent, mais vous ne revint jamais.
...
<br><br><a href=\"http://#SERVER_NAME#\">Visitez-nous maintenant</a>, jetez un oeil sur les nouvelles fonctionnalités et offres. Nous sommes sûrs que vous ne serez pas déçu !
<br>Si vous avez la moindre question, n'hésitez pas à nous contacter.";
$MESS["PRESET_DONT_BUY_LETTER_2_MESSAGE_360"] = "Ça fait tellement longtemps que nous nous sommes vus, vous...
<br>Êtes-vous OK ? Nous sommes vraiment inquiets. Vous nous manquez !
...
<br><br>si vous avez la moindre question, n'hésitez pas à nous contacter.";
$MESS["PRESET_DONT_BUY_LETTER_3_MESSAGE_360"] = "Ça a été une année depuis que nous vous avons vu. Nous sommes désespérés, vraiment. Mais nous ne sommes pas prêts à renoncer à vous encore ! 
<br>Vous savez ce que vous êtes si spécial que nous avons une réduction de 20% pour vous. Oui, vous avez bien entendu. 30%!
<br>Merci de nous donner une chance !
...
$MESS["PRESET_FORGOTTEN_BASKET_LETTER_1_MESSAGE"] = "Bonjour !<br><br>Vous avez été récemment shopping dans notre magasin, mais je n'ai pas terminé la commande.
<br>A l'interface utilisateur trop sophistiqué ? Ou peut-être vous ne trouvez pas votre préféré l'option de paiement ou de prestation de services ?
<br>s'il vous Plaît contactez-nous dès maintenant si vous avez la moindre question en remplissant le bon de commande. Nous aimerions faire de notre mieux pour vous aider.
<br><br>Votre panier est en attente pour vous ! %BASKET_CART%";
...
$MESS["PRESET_MAIL_TEMPLATE_REGARDS"] = "Cordialement,<br>%LINK_START%Web store%LINK_END% de l'équipe.";
$MESS["PRESET_MAIL_TEMPLATE_UNSUB"] = "Pour vous désabonner, veuillez <a href=\"#UNSUBSCRIBE_LINK#\">cliquez ici</a>.";
$MESS["PRESET_PAID_ORDER_DESC"] = "Cet e-mail est envoyé à un client une fois qu'ils ont terminé leur première commande. Le magasin grâce à la clientèle pour l'entreprise, pose à laisser des commentaires et offre une réduction pour la prochaine commande.";
$MESS["PRESET_PAID_ORDER_DESC_USER"] = "Automated e-mail déclenchée";
$MESS["PRESET_PAID_ORDER_LETTER_1_MESSAGE"] = "Bonjour !<br><br>Merci pour le shopping dans notre magasin. Nous vous remercions de votre confiance et espérons que vous magasinez avec nous de nouveau.
<br>Nous apprécions vos commentaires et critiques. Contactez-nous et dites-nous ce qui pourrait rendre votre expérience de magasinage mieux.
<br><br>Merci de nous avoir choisi !";
$MESS["PRESET_PAID_ORDER_LETTER_1_SUBJECT"] = "Merci pour le shopping avec nous !";
$MESS["PRESET_PAID_ORDER_LETTER_2_MESSAGE"] = "Bonjour !<br><br>Vous avez récemment terminé l'ordre sur notre boutique. Merci de nous faire confiance !
<br>Nous espérons que vous avez été satisfait du service et n'ont pas toutes les questions non réglées. N'oubliez pas que vous pouvez toujours nous envoyer un message ou appelez-nous si vous avez n'importe quelle question.
<br>Si vous avez besoin d'un spécialiste de l'opinion ou de toute autre assistance, veuillez contacter notre service client.";
$MESS["PRESET_PAID_ORDER_LETTER_2_SUBJECT"] = "Merci pour l'entreprise !";
$MESS["PRESET_PAID_ORDER_LETTER_3_MESSAGE"] = "Bonjour !<br><br>Vous avez récemment terminé l'ordre sur notre boutique.
<br>Merci de dire aux autres au sujet de votre expérience <a href=\"http://#SERVER_NAME#\">à partir de notre page de Commentaires</a>.
<br>Votre avis nous rendre notre service encore meilleur.
<br>Nous votre avis !
<br>Si vous avez une question à propos de votre commande ou de processus de commande, s'il vous plaît n'hésitez pas à nous contacter.";
$MESS["PRESET_PAID_ORDER_LETTER_3_SUBJECT"] = "Votre opinion compte !";
$MESS["PRESET_PAID_ORDER_LETTER_4_MESSAGE"] = "Bonjour !<br><br>Merci à vous pour faire du shopping avec nous.
<br>Nous avons choisi quelques-uns des offres spéciales de la plupart de nos clients. Nous espérons que vous trouverez notre choix tentant.
<br>si vous avez une question à propos de votre commande ou de processus de commande, s'il vous plaît n'hésitez pas à nous contacter.";
$MESS["PRESET_PAID_ORDER_LETTER_4_SUBJECT"] = "Offres spéciales pour les clients !";
$MESS["PRESET_PAID_ORDER_LETTER_5_MESSAGE"] = "Bonjour !<br><br>Merci à vous pour faire du shopping avec nous. Nous vous remercions de votre confiance et souhaitons apporter notre grâce. Profitez d'une réduction pour votre prochaine commande !
<br>Vous pouvez utiliser le coupon ou le donner à votre ami.
<br>Vous coupon code : <b>%COUPON%</b>.
<br>si vous avez une question à propos de votre commande ou de processus de commande, s'il vous plaît n'hésitez pas à nous contacter.";
