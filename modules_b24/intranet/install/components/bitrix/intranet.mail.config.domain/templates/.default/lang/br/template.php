<?
$MESS["INTR_MAIL_AJAX_ERROR"] = "Erro ao executar consulta";
$MESS["INTR_MAIL_CHECK_JUST_NOW"] = "segundos atrás";
$MESS["INTR_MAIL_CHECK_TEXT"] = "Última verificação em #DATE#";
$MESS["INTR_MAIL_CHECK_TEXT_NA"] = "Não há dados para o status de domínio";
$MESS["INTR_MAIL_CHECK_TEXT_NEXT"] = "Próxima verificação de e-mail em #DATE#";
$MESS["INTR_MAIL_DOMAINREMOVE_CONFIRM"] = "Você deseja desconectar o domínio?";
...
$MESS["INTR_MAIL_DOMAIN_CHOOSE_HINT"] = "Escolha um nome de domínio .com";
...
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1"] = "Passo&nbsp;1.&nbsp;&nbsp;Confirmar a propriedade do domínio";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_A"] = "Carregue um arquivo chamado <b>#SECRET_N#.html</b> para o diretório raiz do site. O arquivo deve conter o texto: <b>#SECRET_C#</b>";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_B"] = "Para configurar o registro CNAME, você precisa ter acesso de gravação nos registros DNS do seu domínio em um registrador ou serviço de hospedagem web com o qual você registrou o seu domínio. Você vai encontrar essas configurações na sua conta ou no painel de controle.";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_B_NAME"] = "Nome de registro: ";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_B_NAMEV"] = "<b>yamail-#SECRET_N#</b> (ou <b>yamail-#SECRET_N#.#DOMAIN#.</b> que depende da interface. Observe o ponto final.)";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_B_PROMPT"] = "Especifique esses valores:";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_B_TYPE"] = "Tipo de registro: ";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_B_VALUE"] = "Valor: ";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_B_VALUEV"] = "<b>mail.yandex.ru.</b> (novamente, observe o ponto)";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_C"] = "Configure o endereço de e-mail para contato em suas informações de registro de domínio como <b>#SECRET_N#@yandex.ru</b>. Use o painel de controle do seu registrador de domínios para configurar o endereço de e-mail.";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_C_HINT"] = "Altere este endereço para seu e-mail real assim que o domínio for confirmado.";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_HINT"] = "Se você tiver qualquer pergunta sobre a verificação da propriedade do seu domínio, entre em contato com o serviço de atendimento em <a href=\"https://helpdesk.bitrix24.com/\" target=\"_blank\">helpdesk.bitrix24.com</a>.";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_OR"] = "ou";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP1_PROMPT"] = "Você precisa confirmar que você possui o nome de domínio especificado usando um dos seguintes métodos:";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP2"] = "Passo&nbsp;2.&nbsp;&nbsp;Configurar registros MX";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP2_HINT"] = "Exclua todos os outros registros MX e TXT que não estão relacionados ao Yandex. As alterações feitas nos registros MX podem levar de algumas horas a três dias para serem atualizadas na Internet.";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP2_MXPROMPT"] = "Crie um novo registro MX com os seguintes parâmetros:";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP2_NAME"] = "Nome de registro:";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP2_NAMEV"] = "<b>@</b> (ou <b>#DOMAIN#.</b> - se necessário. Observe o ponto final)";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP2_PRIORITY"] = "Prioridade: ";
$MESS["INTR_MAIL_DOMAIN_INSTR_STEP2_PROMPT"] = "Depois de ter confirmado sua propriedade do domínio, você terá que alterar os registros MX correspondentes na sua hospedagem na Web.";
...
$MESS["INTR_MAIL_DOMAIN_INSTR_TITLE"] = "Para conectar o seu domínio ao Bitrix24, existem alguns passos.";
...
$MESS["INTR_MAIL_DOMAIN_REMOVE"] = "Desanexar";
...
$MESS["INTR_MAIL_DOMAIN_STATUS_TITLE"] = "Status do link do domínio";
...
$MESS["INTR_MAIL_DOMAIN_TITLE"] = "Se seu domínio estiver configurado para trabalhar em Yandex.Mail para domínios, basta digitar o nome de domínio e o token no formulário abaixo";
$MESS["INTR_MAIL_DOMAIN_TITLE2"] = "Agora, o domínio está vinculado ao seu portal";
...
$MESS["INTR_MAIL_INP_DOMAIN"] = "Nome do domínio";
$MESS["INTR_MAIL_INP_PUBLIC_DOMAIN"] = "Os funcionários podem cadastrar caixas de correio neste domínio";
$MESS["INTR_MAIL_INP_TOKEN"] = "Token";
$MESS["INTR_MAIL_MANAGE"] = "Configurar caixas de correio do funcionário";
?>