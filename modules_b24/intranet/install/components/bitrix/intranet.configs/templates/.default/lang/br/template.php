...
$MESS["CONFIG_ALLOW_NEW_USER_LF"] = "Postar eventos de contratação de novo empregado em Fluxo de Atividades";
$MESS["CONFIG_ALLOW_SELF_REGISTER"] = "Permitir cadastro rápido";
$MESS["CONFIG_ALLOW_TOALL"] = "Permitir \"Todos os funcionários\" como opção no Fluxo de Atividades";
...
$MESS["CONFIG_GDRP_LABEL1"] = "Atualizações de produtos, ofertas especiais, convites para seminários online, compilação de boletins informativos";
...
$MESS["CONFIG_GDRP_TITLE1"] = "Concordo em receber e-mails da Bitrix, Inc. contendo:";
...
$MESS["CONFIG_OTP_POPUP_TEXT"] = "Aqui está o texto que você pode postar num Fluxo de Atividades<br/>para seus funcionários lerem.<br/><br/>Informe aos seus colegas sobre a autenticação de dois passos,<br/>procedimento de configuração e o novo método de autenticação<br/>que eles terão que usar para fazer login";
