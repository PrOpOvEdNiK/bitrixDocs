...
$MESS["INTRANET_USTAT_USER_HELP_ACTIVITY_COMPANY"] = "Valor promedio de las acciones que su compañía hizo en Bitrix24 utilizando una de las siete herramientas disponibles para el período de tiempo especificado. <br><br> Utilice el valor promedio de la compañía para ver cómo su actividad se compara con la de toda la empresa.";
$MESS["INTRANET_USTAT_USER_HELP_ACTIVITY_DEPT"] = "Valor promedio de las acciones que su departamento hizo en Bitrix24 utilizando una de las siete herramientas disponibles para el período de tiempo especificado. <br><br> Utilice el valor promedio del departamento para ver cómo su actividad se compara con las de los demás.";
