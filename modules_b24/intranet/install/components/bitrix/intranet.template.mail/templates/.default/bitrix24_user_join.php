							...
							<table border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0; width: 100%;">
								<tr>
									<td style="padding: 25px 20px;">
										...
										<table border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0; width: 100%;">
											...
											<tr>
												<td align="center" style="text-align: center; padding: 30px 0 5px;">
													<a href="https://<?=BX24_HOST_NAME?>" target="_blank" style="display: inline-block; border-radius: 23px; padding: 0 30px; vertical-align: middle; text-decoration: none; height: 47px; background-color: #9dcf00;">
										...
										<table border="0" cellpadding="0" cellspacing="0" style="margin:30px 0 0 0; padding:0; width: 100%; border-bottom:1px solid #e5e7e9;">
											<tr>
												<td align="center" style="text-align: center; padding: 20px 0; border-top:1px solid #e5e7e9;display: block;color: #333;font-size: 16px;font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
