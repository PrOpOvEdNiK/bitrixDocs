...
El CRM en Bitrix24 es ideal para hacer justamente eso, y podemos usarlo sin abandonar el entorno familiar de nuestra intranet. Y sin tener que recordar las contraseñas de algún otro servicio.
...
Toda la información sobre los clientes (tanto empresas como personas) puede registrarse y buscarse fácilmente en la base de contactos del CRM. Además, se pueden enumerar todas las interacciones y programar interacciones futuras. Las compras o transacciones, llamadas 'Negociaciones' en el CRM, pueden mantenerse individualmente y asociarse con cada cliente.

[IMG WIDTH=500 HEIGHT=347]https://www.bitrix24.com/images/ustat/en/crm2.png[/IMG]

Cada nuevo cliente que aparece debe agregarse al CRM. ¡No olvides hacer esto! Los clientes potenciales (Prospectos) se pueden poner a mano, traídos automáticamente desde el contacto de nuestro sitio web o formulario de comentarios, por correo electrónico o importados de un archivo de datos.
...
Podemos asignar prospectos a diferentes asociados de ventas de forma automática. Todo lo que tenemos que hacer es establecer un Proceso de Negocios que 'clasifique' los prospectos según las condiciones que necesitemos y luego configure a la persona responsable de nuestro equipo de ventas. Por ejemplo, si la 'oportunidad' en el prospecto es más de \$ 9999, podemos enviar esa ventaja directamente al gerente de ventas VIP.
...
No olvide que puede analizar sus datos en cualquier momento - el [B]embudo de ventas[/B] muestra ofertas en sus diversas etapas y le permite filtrar ofertas mostradas por varios criterios.

[IMG WIDTH=500 HEIGHT=359]https://www.bitrix24.com/images/ustat/en/crm8.png[/IMG]

[B]CRM móvil[/B]

Por cierto, para aquellos de ustedes que están en el camino y se reúnen con clientes en el campo, la aplicación móvil tiene el CRM en él. Puede obtener toda la información del cliente, editar los detalles de una negociación después de las negociaciones o actualizar otra información, y luego crear una factura inmediatamente.

[IMG WIDTH=500 HEIGHT=320]https://www.bitrix24.com/images/ustat/en/crm9.jpg[/IMG]

[B]Evalúa tu trabajo en el CRM[/B]

Use el CRM tanto como pueda - las recompensas de tener datos organizados de ventas son innumerables. Para evaluar cómo su actividad del CRM se compara con su departamento o compañía en general, consulte el Company Pulse.

[IMG WIDTH=500 HEIGHT=269]https://www.bitrix24.com/images/ustat/en/crm10.png[/IMG]

[B]Para más información[/B]

Si quieres saber más detalles sobre el CRM, le recomiendo [URL=https://www.bitrixsoft.com/support/training/course/index.php?COURSE_ID=55&CHAPTER_ID=05423]curso de capacitación en línea[/URL].

No te olvides de dar me gusta en esta publicación! :)
...
No hay nada complicado en compartir archivos - incluso puedes crear un archivo en la intranet y compartirlo de inmediato. Para compartir un archivo con colegas para su discusión, mejora o simplemente para su información, puede comenzar simplemente comenzando una nueva publicación en el flujo de actividades. Suba el archivo o cree uno nuevo (vea la esquina inferior derecha de la imagen a continuación).
...
Después de editar el documento y guardarlo, dentro de flujo de actividad se creará un nuevo comentario que indica que usted ha creado una nueva versión del documento.
...
Si un correo o mensaje de un colega está en el flujo de actividad, puede marcarlo como 'me Gusta' con el me gusta que el mesaje tiene debajo. Sólo tomará un segundo, pero hará saber a la persona que escribe que la contribución fue valiosa para alguien y permitirá a otros saber que podría ser útil para ellos.
...
[*]y, por último, puedes darle 'me gusta' publicar y aumentar la moral :)
[/LIST]

Sugiero iniciar conociendo la funcionalidad de nuestra intranet social en este momento. Te diré cómo hacerlo.

[VIDEO WIDTH=400 HEIGHT=300]https://www.youtube.com/watch?v=fN6BsyjOOtY[/VIDEO]

[B]¿Cómo enviar un mensaje?[/B]

En nuestra intranet puede compartir cualquier información relevante para el trabajo. Los mensajes se pueden enviar a todos los empleados, a un grupo individual o a un solo usuario. Los destinatarios verán su mensaje en general [I]Flujo de actividad[/I].
...
Además, puede verificar qué tan bien ha aprendido su equipo a utilizar las distintas herramientas dentro de Bitrix24; sólo use la función Company Pulse y observe la actividad.

[IMG WIDTH=500 HEIGHT=271]https://www.bitrix24.com/images/ustat/en/socnet5.png[/IMG]

Company Pulse lo ayuda a mantener un seguimiento preciso de como su red social se va integrando a las actividades cotidianas de su empresa. Cada empleado tiene su propio score, el mismo que puede ser comparado con otros colegas de su departamento o de toda la compañía. 
