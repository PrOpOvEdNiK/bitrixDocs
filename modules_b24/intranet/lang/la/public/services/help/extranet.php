...
<p>El módulo Extranet es una ampliación del Portal de Intranet que permite a una empresa establecer una comunicación confidencial con contratistas, proveedores, distribuidores u otros usuarios externos, gestionando prohibiciones a terceros de tal manera que se evita su acceso a información privada de la empresa.</p>
<p>La Extranet es un espacio de información segura para interactuar con el entorno externo. El espacio web colectivo está especialmente diseñado para una cooperación eficaz con socios y otros agentes externos. Invite a sus socios y colegas a los grupos de trabajo de la extranet y trabaje sobre sus tareas y problemas compartidos de forma colectiva. Esta solución garantiza que su comunicación es segura mientras se mantiene la integridad de la intranet.<br />
</p>
...
<p>Tan pronto como el asistente se complete, un item de <strong>Extranet</strong> será mostrado en el menú superior. El sistema de <strong>Extranet</strong> está levantado, ejecutándose y disponible para ser visitado.</p>
