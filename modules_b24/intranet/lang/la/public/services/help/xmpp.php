<?
$MESS["SERVICES_INFO"] = "<p>El portal cuenta con un servidor privado <b>XMPP/JABBER</b>! Manténgase conectado y <b>en línea!,</b> intercambie mensajes y archivos, disfrute de chats de audio y video, todo desde su software movil o de mensajería favorito!</p>
    ...
    <tr>
      <td valign='top'><img hspace='10' height='15' width='12' src='#SITE#images/docs/cp/bullet-n.gif' />intercambio de mensajes (IM);
       ...
       <img hspace='10' height='15' width='12' src='#SITE#images/docs/cp/bullet-n.gif' />intercambio de archivos;
        <br />
       <img hspace='10' height='15' width='12' src='#SITE#images/docs/cp/bullet-n.gif' />siempre en línea; <br />
       ...
       <img hspace='10' height='15' width='12' src='#SITE#images/docs/cp/bullet-n.gif' />portal móvil; <br />
       <img hspace='10' height='15' width='12' src='#SITE#images/docs/cp/bullet-n.gif' />listas de contactos pre-creadas; <br />
       <img hspace='10' height='15' width='12' src='#SITE#images/docs/cp/bullet-n.gif' />historial de mensajería común; <br />
