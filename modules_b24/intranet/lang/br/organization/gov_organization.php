...
Acesso configurável às áreas do portal nos oferecem recursos de trabalho em equipe: agora, podemos juntos editar documentos; criar grupos de trabalho; elaborar relatórios!
...
$MESS["CONFIG_ALLOW_NEW_USER_LF"] = "Postar notificação de novo funcionário no Fluxo de Atividades";
...
$MESS["CONFIG_IM_GENERSL_CHAT_MESSAGE_JOIN"] = "Postar notificação de novo funcionário no bate-papo público";
$MESS["CONFIG_IM_GENERSL_CHAT_MESSAGE_LEAVE"] = "Postar notificação de descarte de funcionário no bate-papo público";
$MESS["CONFIG_LOGO_24"] = "Adicionar \"24\" ao logotipo da organização";
$MESS["CONFIG_OTP_ADMIN_IS_REQUIRED_INFO"] = "Antes de migrar seus usuários para o sistema de autenticação em duas etapas, primeiro configure-o para a sua conta.<br/><br/>Prossiga, ativando-o na página de Segurança do seu perfil.";
...
Para proteger contra possíveis ameaças, ativamos um recurso extra de segurança para o Bitrix24: autenticação em duas etapas.

A autenticação em duas etapas é um método especial para proteger de hackers de software, particularmente roubo de senha. Cada vez que você faz login no sistema, você vai ter que passar por dois níveis de verificação. Primeiro, você digitará seu endereço de e-mail e senha. Então, você digitará um único código de segurança, obtido a partir do seu dispositivo móvel.

Isso tornará os dados empresariais seguros, mesmo se o login e a senha de qualquer usuário forem roubados por um invasor.
...
$MESS["CONFIG_OTP_POPUP_TEXT"] = "Aqui está o texto que você pode postar no Fluxo de Atividades<br/>para seus usuários lerem.<br/><br/>
Informe seus colegas sobre o procedimento de configuração da autenticação em duas etapas<br/>e o novo método de autenticação<br/>que eles terão que usar para fazer login no Bitrix24.";
$MESS["CONFIG_OTP_SECURITY"] = "Ativar autenticação em duas etapas para todos os usuários";
$MESS["CONFIG_OTP_SECURITY2"] = "Tornar a autorização em duas etapas obrigatória para todos os usuários";
$MESS["CONFIG_OTP_SECURITY_DAYS"] = "Especificar o período de tempo dentro do qual todos os usuários<br/>terão que ativar a autenticação em duas etapas";
$MESS["CONFIG_OTP_SECURITY_INFO"] = "Desenvolvemos um amigável procedimento de ativação da autenticação em duas etapas que qualquer usuário pode fazer sem a ajuda de um especialista.<br/><br/>
Será enviada uma mensagem a cada usuário, notificando que eles terão que ativar a autenticação em duas etapas dentro do período de tempo introduzido. Os usuários que não fizerem isso, não poderão mais entrar.";
$MESS["CONFIG_OTP_SECURITY_INFO2"] = "<br/>Para ativar a autenticação em duas etapas, o usuário deve instalar o aplicativo OTP Bitrix24 em seu telefone celular. Este aplicativo pode ser baixado da AppStore ou GooglePlay.<br/><br/>
...
<br/><br/>
Como opção, você pode desativar a autenticação em duas etapas para alguns dos usuários. No entanto, isso irá aumentar o risco de acesso não autorizado ao seu Bitrix24 se o login e a senha de um desses usuários forem roubados. Como administrador, você pode desativar a autenticação em duas etapas para um usuário no perfil do usuário.";
...
$MESS["IM_CL_USER_B24"] = "Empregado";
$MESS["IM_CTL_CHAT_STRUCTURE"] = "Estrutura do escritório";
$MESS["IM_C_ABOUT_CHAT"] = "O bate-papo privado é visível apenas para pessoas convidadas. #BR##BR# Além de seus colegas e empregados que trabalham em seu escritório, você pode convidar clientes, parceiros, fornecedores - qualquer um que tenha seu próprio Bitrix24. Para adicionar uma nova pessoa, digite o nome dela, e-mail ou apelido. #BR##BR##PROFILE_START#Edite seu perfil#PROFILE_END# para possibilitar que outras pessoas o encontrem.";
...
$MESS["INTRANET_USER_ADD_DESC"] = "#EMAIL_TO# - endereço de e-mail de novo usuário
 #LINK# - URL da intranet";
$MESS["INTRANET_USER_ADD_NAME"] = "Adicionar usuários";
$MESS["INTRANET_USER_INVITATION_DESC"] = "#EMAIL_TO# - endereços de e-mail das pessoas convidadas
...
$MESS["INTRANET_USTAT_USER_HELP_ACTIVITY_COMPANY"] = "Valor médio das ações que sua organização fez no Bitrix24 usando uma das sete ferramentas disponíveis para o período de tempo especificado.<br><br> <b>Use o valor médio da organização para ver como sua atividade está melhor do que a de toda a organização.";
$MESS["INTRANET_USTAT_USER_HELP_ACTIVITY_DEPT"] = "Valor médio das ações que sua divisão fez no Bitrix24 usando uma das sete ferramentas disponíveis para o período de tempo especificado.<br><br> <b>Use o valor médio da divisão para ver como sua atividade está melhor do que a dos outros.";
...
$MESS["INTR_COMP_IS_TPL_TOOLBAR_USER_INVITE"] = "Convidar usuários";
...
$MESS["INTR_MAIL_DESCR_B24"] = "Servidor de e-mail gratuito para a sua empresa! Armazenamento ilimitado para seu e-mail, antivírus e antispam para manter sua caixa de entrada limpa. Migre seu e-mail corporativo para o Bitrix24! Crie suas próprias caixas de correio no domínio empresarial no Bitrix24 ou anexe caixas de correio de outros serviços de e-mail.";
...
$MESS["INTR_MAIL_MANAGE_SETUP_ALLOW_CRM"] = "Os funcionários podem conectar caixas de correio ao CRM";
...
$MESS["ISV_set_department_head"] = "<b>#NAME#</b> foi nomeado como chefe da divisão <b>#DEPARTMENT#</b>.";
...
$MESS["MENU_COMPANY_SECTION"] = "Instituição";
...
$MESS["SONET_LIVEFEED_RENDERPARTS_USER_ALL"] = "Para todos os usuários";
